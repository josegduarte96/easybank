...
<div class="container-fluid">
  <footer class="row py-5 border-top bg-primary">
    <div class="col">
        <div class="col-12 d-flex justify-content-center">
            <img src="../assets/logo-white.svg" alt="">
        </div>
        <div id="icons" class="col-12 d-flex justify-content-center mt-3 mt-lg-5">
            <svg class="p-2" xmlns="http://www.w3.org/2000/svg" width="37" height="37">
    ...
    <div class="col col-12 col-md-3 col-lg-3 d-flex flex-row">
        <ul class="m-0 col-12 col-sm-6 col-md-6 col-lg-6 text-center">
    ...
    <div class="col col-12 col-md-3 col-lg-3 d-flex flex-row">
      <ul class="m-0 col-12 col-sm-6 col-md-6 col-lg-6 text-center">
         <li class="text-light">Careers</li>
         <li class="text-light">Support</li>
         <li class="text-light">Privacy Policy</li>
      </ul>
    </div>

    <div class="col d-flex flex-column justify-content-center align-items-center align-items-lg-end mt-2">
            <button class=" btn btn-light bg-gradient float-end rounded-pill text-white m-2">
                Request Invite
            </button>
            <p class=" py-3 text-info">© Easybank. All Rights Reserved</p>
    </div>
  </footer>
</div>
</template>
...
li{
    ...
    cursor: pointer;
    &:hover{
        color: hsl(192, 70%, 51%) !important;
    }
}
svg:hover > path {
    cursor: pointer;
    fill: hsl(192, 70%, 51%) !important;
}
img{
    cursor: pointer;
}
